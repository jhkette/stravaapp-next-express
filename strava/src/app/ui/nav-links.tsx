      ...
      {links.map((link) => {
        ...
        return (
          <Link
            ...
            className={clsx(
              "flex h-[52px] text-gray-800 rounded-lg grow items-center justify-center gap-2 p-3 mb-2 text-sm font-medium hover:bg-sky-100 hover:text-blue-600 md:flex-none md:justify-start md:p-2 md:px-3",
              {
