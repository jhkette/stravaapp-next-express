...
export default function FtpChart({ ftp }: FtpChartProps) {
  if (!ftp) {
      ...
      <table className="border-collapse table-fixed w-full text-sm ">
        <thead>
          <tr className="shadow-xl">
            <th className="border-b border-slate-600  pl-4  pb-4 text-left">
              Zone
            </th>
            <th className="border-b border-slate-600   pb-4 pl-4   text-left">
              Watts
            </th>
          </tr>
        </thead>
